...
export default async function MentorAvailabilityPage() {
  ...
  return (
    <div className="bg-zinc-50 min-h-screen pb-24">
      <header className="bg-blue-600 px-6 pt-12 pb-10 text-white relative z-10 flex items-center justify-between w-full">
      ...
      <div className="mx-auto flex max-w-xl flex-col gap-6 px-4 -mt-6 relative z-20">

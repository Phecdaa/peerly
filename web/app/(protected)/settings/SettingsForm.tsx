...
export function SettingsForm({ user, profile }: any) {
  ...
  return (
    <div className="pb-8">
      ...
      <div className="bg-blue-600 h-36 relative flex justify-between px-6 pt-8 text-white md:rounded-b-3xl">
        <button onClick={() => router.back()} className="h-fit p-1 -ml-1 hover:bg-white/20 rounded-full transition">
           <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" /></svg>
        </button>
        <span className="font-bold text-lg tracking-wide">Akun</span>

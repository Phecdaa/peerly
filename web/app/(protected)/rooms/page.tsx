...
export default async function RoomsPage() {
  ...
  const isMentorRole = profile?.is_mentor ?? false;
    ...
    return (
      <div className="bg-zinc-50 min-h-screen pb-24 md:px-6">
        <header className="bg-blue-600 px-6 pt-12 pb-10 text-white relative z-10 flex items-center justify-between w-full md:rounded-3xl md:mt-6 md:pb-16 md:px-10">
          ...
          <div className="hidden md:block">
            ...
            <p className="text-sm text-blue-100 opacity-90 mt-1">Kelola tiket sesi belajarmu di sini.</p>
          </div>
      ...
      <div className="px-4 -mt-6 relative z-20 space-y-8 pb-10 md:-mt-8 md:px-10">
        <RoomsTabs
